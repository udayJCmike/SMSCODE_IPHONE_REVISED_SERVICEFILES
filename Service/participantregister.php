...
if(($count1>0) || ($count2>0) || ($count3>0))
{
    ...
    if($count3 > 0)
    {
            ...
            else
        {
            ...
            $patmed = "INSERT INTO login (login_id, username, password, email_id, role, status) VALUES ('', '".$username."', '".$password."', '".$email."', '0', '1')";
 			mysql_query($patmed);
...
for($i=1;$i<=12;$i++)
{
    ...
    $day+=7;
            ...
            else
            {
              ...
              $userlogs="insert into user_roles (USER_ROLE_ID,USER_ID,AUTHORITY) values ('','".$loginid."','ROLE_USER')";
...
*/
    case 'weeklyevaluation':
    {
        ...
        $ans1=$_POST['answer1'];
        $ans2=mysql_real_escape_string($_POST['answer2']);
        $ans3=$_POST['answer3'];
        $text_message=addslashes($_POST['textmessage']);
        $ques1='1001';
        $ques2='1002';
        $ques3='1003';
        ...
        $countcol1=$_POST['countcol'];
                    ...
                    $insertquery="insert into weekly_answers(id,log_id,question1,answer1,question2,answer2,question3,answer3,text_message,attend_date,status)values('','".$weeklogid1."','".$ques1."','".$ans1."','".$ques2."','".$ans2."','".$ques3."','".$ans3."','".$text_message."',NOW(),'1')";
